...
Reference your build notes for raw material — decisions, tradeoffs, surprises. Reference agents-publish.md for the sub-agents' perspective. But the writing is yours.
...
The three agents were tested against this very build process itself. Process phases were fed back to each agent and their responses were compared.
...
The agent files and build system are open source: [github.com/wolfazoid/tiny-products](https://github.com/wolfazoid/tiny-products)

- Agent template structure: `.claude/sub-agents/engineer/AGENT.md`
- Full build process: `CLAUDE.md`
- This build's artifacts: `builds/002-perspective-panel/`
